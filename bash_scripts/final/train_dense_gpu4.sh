...
python train.py --experiment_name ws$SUFFIX --models $WS --models_valid $WS $GPU_IDS $NUM_EPOCHS $METRIC_NAME
python train.py --experiment_name s$SUFFIX --models $S --models_valid $S $GPU_IDS $NUM_EPOCHS $METRIC_NAME
