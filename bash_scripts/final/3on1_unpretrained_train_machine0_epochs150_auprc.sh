SUFFIX="_3on1_auprc_unpretrained"
...
python train.py --experiment_name bps$SUFFIX --models $BPS --models_valid $BPS --gpu_ids 1 $NUM_EPOCHS $METRIC_NAME --no-pretrained
python train.py --experiment_name pws$SUFFIX --models $PWS --models_valid $PWS --gpu_ids 2 $NUM_EPOCHS $METRIC_NAME --no-pretrained
