declare -a suffixes=("_unpretrained")
...
do
    ...
    do
        ...
        python test.py --ckpt_path "${paths[$j]}" --models_test $B --final_csv --no-pretrained
        python test.py --ckpt_path "${paths[$j]}" --models_test $P --final_csv --no-pretrained
        python test.py --ckpt_path "${paths[$j]}" --models_test $W --final_csv --no-pretrained
        python test.py --ckpt_path "${paths[$j]}" --models_test $S --final_csv --no-pretrained
