...
python train.py --experiment_name bpws$SUFFIX --models $BPWS --models_valid $BPWS $GPU_IDS $NUM_EPOCHS $METRIC_NAME --no-pretrained
python train.py --experiment_name pw$SUFFIX --models $PW --models_valid $PW $GPU_IDS $NUM_EPOCHS $METRIC_NAME --no-pretrained
python train.py --experiment_name bps$SUFFIX --models $BPS --models_valid $BPS $GPU_IDS $NUM_EPOCHS $METRIC_NAME --no-pretrained
